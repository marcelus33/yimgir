 ...
 */
class MisionesDiplomaticas extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'comprobantes' => array(self::HAS_MANY, 'Comprobantes', 'id_misiones_diplomaticas'),
		);
	}
	 ...
	 * @return MisionesDiplomaticas the static model class
	 */
