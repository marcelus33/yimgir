...
class TbButtonColumn extends CButtonColumn
{
	...
	public $descargarButtonIcon = 'download-alt';

	public $restaurarButtonIcon = 'refresh';
	...
	protected function initDefaultButtons()
	{
		...
		if ($this->viewButtonIcon !== false && !isset($this->buttons['ver']['icon'])) {
			$this->buttons['ver']['icon'] = $this->viewButtonIcon;
		}
		...
		if ($this->descargarButtonIcon !== false && !isset($this->buttons['descargar']['icon'])) {
			$this->buttons['descargar']['icon'] = $this->descargarButtonIcon;
		}

		if ($this->restaurarButtonIcon !== false && !isset($this->buttons['restaurar']['icon'])) {
			$this->buttons['restaurar']['icon'] = $this->restaurarButtonIcon;
		}
	}
